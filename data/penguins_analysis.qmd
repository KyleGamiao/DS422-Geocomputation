...
ggplot(data = penguins_data_from_csv, 
  ...
  labs(
    title = "Palmer Penguins: Culmen Depth vs Body Mass",
    subtitle = "Relationship across 3 penguin species in the Palmer Archipelago",
    x = "Culmen Depth (mm)",
    y = "Body Mass (g)"
  )
...
```{r}
ggplot(data = average_species_flipper_length, 
  ...
  theme(legend.position = "none") +
  labs(
    title = "Palmer Penguins: Average Flipper Length by Species",
    subtitle = "3 penguin species observed in the Palmer Archipelago, Antarctica",
